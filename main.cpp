...
void test_reshaping(void)
{
    ...
    // NumCpp<float>::linspace(0.f, 3.6f, 6).disp("original");
    // NumCpp<float> t1 = NumCpp<float>::linspace(0.f, 3.6f, 6).trans();
    // NumCpp<float> t2 = NumCpp<float>::linspace(0.f, 3.6f, 6).trans().trans();
    // t1.disp("transpose 1");
    // t2.disp("transpose 2");
    // NumCpp<float> t3 = NumCpp<float>::arange(0.f, 9.f, 1.f, false).reshape(3, 3).trans();
    // t3.disp("transpose 3");
    // NumCpp<float> t4 = NumCpp<float>::arange(0.f, 16.f, 1.f, false).reshape(4, 4).trans();
    // t4.disp("transpose 4");
    NumCpp<float> t5 = NumCpp<float>::arange(0.f, 16.f, 1.f, false).reshape(2, 8).trans();
    t5.disp("transpose 5");
}
